...
class UAM(ImageDataset):
    ...
    dataset_dir = './ReID/crosswalks/crosswalk13new/'#'./ReID/rubishbins/'
    dataset_dir_test = './ReID/crosswalks/ccrosswalk13new/'
    def __init__(self, root='./Part-Aware-Transformer/data',
                 verbose=True, **kwargs):
        # cambiado para .bash
      ...
      #  self.num_train_pids, self.num_train_imgs, self.num_train_cams = self.get_imagedata_info(self.train)
       # self.num_query_pids, self.num_query_imgs, self.num_query_cams = self.get_imagedata_info(self.query)
        ...
        super(UAM, self).__init__( self.train , self.query, self.gallery, **kwargs)
