...
class UAM_test(ImageDataset):
    ...
    dataset_dir_test = './ReID/crosswalks/crosswalk13new/'

    def __init__(self, root='./ReID/feature_learning-master/Feature_Learning/learning_model/data',
                 verbose=True, **kwargs):
       ...
       # if verbose:
        ...
        super(UAM_test, self).__init__( self.train , self.query, self.gallery, **kwargs)
